...
def main():
    ...
    for section, section_val in sections.items():
        for workload in workloads:
            ...
            cmd = f"sudo powermetrics -i 100 --samplers cpu_power,gpu_power -a --hide-cpu-duty-cycle --show-usage-summary --show-extra-power-info -u {outputFile}"
            print(cmd)
            ...
            os.system(f"sudo pkill -u root powermetrics")
